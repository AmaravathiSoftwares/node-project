...
export const esevaValidator = {
    ...
    "e_darshnam_ordersValidator": [
        ...
        //     .trim()
        //     .notEmpty()
        //     .withMessage('Ticket_type is required')
        //     .customSanitizer(preventFormulaInjection),
        // body('seva_name')
        //     .trim()
        //     .notEmpty()
        //     .withMessage('Seva_name is required')
        //     .customSanitizer(preventFormulaInjection),
        body('devotee_name')
            .trim()
            .notEmpty()
        ...
        //     .trim()
        //     .notEmpty()
        //     .withMessage('Slot_time is required')
        //     .customSanitizer(preventFormulaInjection),
        body('darshanam_date')
            .trim()
            .notEmpty()
    ...
    "temple_profile": [
        ...
        //     .trim()
        //     .notEmpty()
        //     .withMessage('temple_photo is required'),
    ],
    "editdharshanam": [
    ...
    "createPrasadamOrder": [
        ...
        body('prasadam_id')
            .trim()
            .notEmpty()
            .withMessage('prasadam_id is required')
            .matches(/^[0-9]+$/)
            .withMessage('prasadam_id must be numeric')
            .customSanitizer(preventFormulaInjection),
        body('qty')
            .trim()
            .notEmpty()
    ...
    "addUserineMasters": [
        ...
        body('number')
            ...
            .matches(/^[6-9][0-9]{9}$/)
            .withMessage('Number must start with 6–9 and contain exactly 10 digits')
            .customSanitizer(preventFormulaInjection),
        ...
        body('designation')
            ...
            .matches(/^[A-Za-z\s]+$/)
            .withMessage('Designation must contain only letters')
            .customSanitizer(preventFormulaInjection),
    ],
